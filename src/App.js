  ...
  return (
    <div className="contaier-page">
      <div className="team-description">
        ...
        <p> 
          Olá! Nós somos os Avengers, mas ao contrário do que você pode estar pensando este não é nenhum filme da Marvel, é o <label>Gama Experience</label>(by Gama Academy), 
